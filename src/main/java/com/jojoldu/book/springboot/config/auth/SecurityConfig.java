...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // authorizeRequests : URL 별 권한 관리를 설정하는 옵션의 시작점. authorizeRequests 가 선언되야만 antMatchers 옵션 사용 가능
        ...
        //      여기선 authenticated() 을 추가하여 나머지 URL 들은 모두 인증된 사용자들에게만 허용하게 함
        //      인가된 사용자 즉, 로그인한 사용자들을 이야기함
        ...
        //      리소스 서버(즉, 소셜 서비스들)에서 사용자 정보를 가져온 상태에서 추가로 진행하고자 하는 기능을 명시함
